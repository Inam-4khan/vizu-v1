...
export const FlowPage: React.FC<FlowPageProps> = ({ onExplore, onNotifications, onAddStory, onViewStory, isGhostMode }) => {
  ...
  const handleTouchMove = (e: React.TouchEvent) => {
    if (touchStartPos !== null && containerRef.current && containerRef.current.scrollTop <= 0) {
