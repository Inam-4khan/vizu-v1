            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-between group pt-4 border-t border-primary/5">
                ...
                <button 
                  ...
                  className={`w-12 h-6 rounded-full relative transition-all duration-500 shadow-inner ${quietHours ? 'bg-orange-600' : 'bg-gray-200'}`}
                >
              ...
              <div className="flex items-center justify-between group pt-4 border-t border-primary/5">
                ...
                <button 
                  ...
                  className={`w-12 h-6 rounded-full relative transition-all duration-500 shadow-inner ${ageFiltering ? 'bg-secondary' : 'bg-gray-200'}`}
                >
