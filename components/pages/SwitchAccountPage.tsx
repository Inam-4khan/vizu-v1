...
export const SwitchAccountPage: React.FC<SwitchAccountPageProps> = ({ currentUser, onSelect, onBack }) => {
  return (
            ...
            return (
              ...
              >
                <div className="relative">
                  <img src={user.avatar} className="w-14 h-14 rounded-2xl border-2 border-[var(--app-bg,#FFF9E6)] shadow-inner" alt="" />
                  {isCurrent && (
