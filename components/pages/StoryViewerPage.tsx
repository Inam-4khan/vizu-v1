...
export const StoryViewerPage: React.FC<StoryViewerPageProps> = ({ storyId, onClose, isGhostMode }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-xl flex flex-col max-w-md mx-auto h-full w-full select-none">
      <div 
